load("C:/Users/Cliente/Downloads/painelid_0709_1.Rdata")
...
## Modelo Pooled
reg.pooled <- plm(ln_salario ~ sexo + licença + sexo:licença + afastamento_licença + grau_instr + temp_empr + idade , data = painel, model='pooling')
summary(reg.pooled)

## Modelo Efeitos Fixos
reg.ef <- plm(ln_salario ~ sexo + licença + sexo:licença + afastamento_licença + grau_instr + temp_empr + idade , data = painel, model='within')
summary(reg.ef)

## Modelo de Efeitos Aleatórios
reg.ea=plm(ln_salario ~ sexo + licença + sexo:licença + afastamento_licença + grau_instr + temp_empr + idade , data = painel, model="random", random.method = "walhus")
summary(reg.ea)
