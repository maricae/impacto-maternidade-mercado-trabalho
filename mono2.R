...
## Modelo Pooled
reg.pooled <- plm(ln_salario ~ sexo + licença + sexo:licença + afastamento_licença + afastamento_licença2 + grau_instr + temp_empr + idade + idade2 , data = painel, model='pooling')
summary(reg.pooled)

## Modelo Efeitos Fixos
reg.ef <- plm(ln_salario ~ sexo + licença + sexo:licença + afastamento_licença + afastamento_licença2 + grau_instr + temp_empr + idade + idade2 , data = painel, model='within')
summary(reg.ef)

## Modelo de Efeitos Aleatórios
reg.ea <- plm(ln_salario ~ sexo + licença + sexo:licença + afastamento_licença + afastamento_licença2 + grau_instr + temp_empr + idade + idade2 , data = painel, model="random", random.method = "walhus")
summary(reg.ea)
